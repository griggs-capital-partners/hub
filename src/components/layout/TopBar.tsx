...
const PAGE_TITLES: Record<string, { title: string; subtitle: string }> = {
  "/dashboard": { title: "Home", subtitle: "Team collaboration hub" },
  "/chat": { title: "Team Chat", subtitle: "Griggs Capital Partners" },
  "/repos": { title: "Codebase", subtitle: "GitHub repositories & systems" },
  "/customers": { title: "Customer Intelligence", subtitle: "Knowledge base & insights" },
  "/activity": { title: "Wildfires", subtitle: "Active issues & critical alerts" },
  "/intelligence": { title: "Intelligence", subtitle: "AI-powered analysis" },
  "/weekly-notes": { title: "Weekly Notes", subtitle: "Customer focused activities" },
  "/settings": { title: "Settings", subtitle: "Hub configuration" },
  "/mqtt-portal": { title: "MQTT Portal", subtitle: "Broker security — clients, roles & user mappings" },
  "/pages/": { title: "Tools", subtitle: "Custom pages" },
};
